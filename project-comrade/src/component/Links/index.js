    ...
    return(
        <div style={{backgroundColor:'#F5F7F7',display:'flex',justifyContent:"center", height:"80vh",padding:"35px 0px"}}>
            ...
            <CardContent className="delete" style={{background:"#3A6EFA", borderRadius:"5px"}}>
                ...
                <TextField id="standard-basic" onKeyDown={(e)=>{this.handleKeyDown(e,"futureDomain")}}  onChange={(e)=>{this.handleChange(e, "domain")}} style={{marginTop:"20px", width:"100%"}} label="Links" variant="standard" />
            </div>
        </div>
    )
    }
